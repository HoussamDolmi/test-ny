...
import SingleProjectContext from '../../context/project5';
								...
								return (
									...
									>
										...
										<a
											...
											rel="noreferrer"
											className={
												info.title === 'User Experience for Laptop' ||
												info.title === 'User Experience for Tablette' ||
												info.title === 'User Experience for Phone'
												
													? 'hover:underline hover:text-orange-500 dark:hover:text-orange-400 cursor-pointer duration-300'
													: ''
											}
							...
							(social) => {
								return (
									<a
										...
										className="bg-ternary-light dark:bg-ternary-dark text-gray-400 hover:text-orange-500 dark:hover:text-primary-light p-2 rounded-lg shadow-sm duration-500"
									>
